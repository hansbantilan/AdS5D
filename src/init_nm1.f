...
c----------------------------------------------------------------------
     ...
     &                      L,phys_bdy,x,y,dt,chr,ex,Nx,Ny,regtype)
        ...
        real*8 phi4r_t0,phi4r_tt0
        real*8 phi4i_t0,phi4i_tt0

        real*8 h0_ll_tt(5,5),phi10_tt,phi4r0_tt,phi4i0_tt
     ...
     &                set_ll(4,5)*g0_uu(4,5))
              ...
              ! need this in h0_ll_tt,phi10_tt,phi4r0_tt,phi4i0_tt calculations
              phi10_x(1)    =phi1_t_n(i,j)*(1-rho0**2)**4
              phi4r0_x(1)   =phi4_r_t_n(i,j)*(1-rho0**2)**4
              phi4i0_x(1)   =phi4_i_t_n(i,j)*(1-rho0**2)**4
              ...
              phi1_t0 =phi1_t_n(i,j)*(1-rho0**2)**4
              phi4r_t0=phi4_r_t_n(i,j)*(1-rho0**2)**4
              phi4i_t0=phi4_i_t_n(i,j)*(1-rho0**2)**4
     ...
     &                                                                )
              ...
              ! 0 = g^ab phi4,ab - g^ab gamma^c_ab phi4,c 
              phi4r0_tt=-1/g0_uu(1,1)
     &                  *(
     ...
     &                  -
     &                      phi4r0_x(1)*( gamma_ull(1,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(1,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(1,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(1,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(1,5,5)*g0_uu(5,5)+
     ...
     &                                    gamma_ull(1,4,5)*g0_uu(4,5)) )
     &                    -
     &                      phi4r0_x(2)*( gamma_ull(2,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(2,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(2,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(2,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(2,5,5)*g0_uu(5,5)+
     ...
     &                                    gamma_ull(2,4,5)*g0_uu(4,5)) )
     &                    -
     &                      phi4r0_x(3)*( gamma_ull(3,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(3,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(3,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(3,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(3,5,5)*g0_uu(5,5)+
     ...
     &                                    gamma_ull(3,4,5)*g0_uu(4,5)) )
     &                    -
     &                      phi4r0_x(4)*( gamma_ull(4,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(4,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(4,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(4,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(4,5,5)*g0_uu(5,5)+
     ...
     &                                    gamma_ull(4,4,5)*g0_uu(4,5)) )
     &                    -
     &                      phi4r0_x(5)*( gamma_ull(5,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(5,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(5,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(5,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(5,5,5)*g0_uu(5,5)+
     ...
     &                  -
     &                      phi4i0_x(1)*( gamma_ull(1,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(1,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(1,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(1,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(1,5,5)*g0_uu(5,5)+
     ...
     &                                    gamma_ull(1,4,5)*g0_uu(4,5)) )
     &                    -
     &                      phi4i0_x(2)*( gamma_ull(2,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(2,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(2,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(2,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(2,5,5)*g0_uu(5,5)+
     ...
     &                                    gamma_ull(2,4,5)*g0_uu(4,5)) )
     &                    -
     &                      phi4i0_x(3)*( gamma_ull(3,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(3,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(3,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(3,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(3,5,5)*g0_uu(5,5)+
     ...
     &                                    gamma_ull(3,4,5)*g0_uu(4,5)) )
     &                    -
     &                      phi4i0_x(4)*( gamma_ull(4,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(4,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(4,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(4,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(4,5,5)*g0_uu(5,5)+
     ...
     &                                    gamma_ull(4,4,5)*g0_uu(4,5)) )
     &                    -
     &                      phi4i0_x(5)*( gamma_ull(5,1,1)*g0_uu(1,1)+
     &                                    gamma_ull(5,2,2)*g0_uu(2,2)+
     &                                    gamma_ull(5,3,3)*g0_uu(3,3)+
     &                                    gamma_ull(5,4,4)*g0_uu(4,4)+
     &                                    gamma_ull(5,5,5)*g0_uu(5,5)+
     ...
     &        .or.is_nan(h0_ll_tt(4,4)).or.is_nan(h0_ll_tt(5,5)) ) then
              ...
              phi1_tt0 =phi10_tt/(1-rho0**2)**4
              phi4r_tt0=phi4r0_tt/(1-rho0**2)**4
              phi4i_tt0=phi4i0_tt/(1-rho0**2)**4
     ...
     &                         + phi1_tt0*dt**2/2
              phi4_r_nm1(i,j)=phi4_r_n(i,j) - phi4r_t0*dt
     &                         + phi4r_tt0*dt**2/2
              phi4_i_nm1(i,j)=phi4_i_n(i,j) - phi4i_t0*dt
     &                         + phi4i_tt0*dt**2/2
     ...
     &                         + phi1_tt0*dt**2/2
              phi4_r_np1(i,j)=phi4_r_n(i,j) + phi4r_t0*dt
     &                         + phi4r_tt0*dt**2/2
              phi4_i_np1(i,j)=phi4_i_n(i,j) + phi4i_t0*dt
     &                         + phi4i_tt0*dt**2/2
        ...
        call axi_reg_phi(phi4_r_nm1,chr,ex,L,x,y,Nx,Ny,regtype)
        call axi_reg_phi(phi4_r_np1,chr,ex,L,x,y,Nx,Ny,regtype)
        call axi_reg_phi(phi4_i_nm1,chr,ex,L,x,y,Nx,Ny,regtype)
