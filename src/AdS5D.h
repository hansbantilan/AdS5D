...
/*============================================================================= */
/* global variables and prototypes for AdS5D                                    */
/*============================================================================= */
...
extern int which_gb_ii_delta_ads; 
...
void g_evo_opt_(real *gb_res, real *phi1_res, real *phi4_res, real *cl_res,
                ...
                real *phi1_np1, real *phi1_n, real *phi1_nm1,
                 real *phi4_r_np1, real *phi4_r_n, real *phi4_r_nm1,
                 real *phi4_i_np1, real *phi4_i_n, real *phi4_i_nm1,
...
void init_ghb_bs_(real *gb_tt, real *gb_tx, real *gb_ty,
                  real *gb_xx, real *gb_xy, real *gb_yy, real *psi,
...
void phi1dat_(real *phi1, real *xc, real *yc, real *AdS_L, real *x, real *y, int *Nx, int *Ny);

void phi4dat_(real *phi4, real *xc, real *yc, real *AdS_L, real *x, real *y, int *Nx, int *Ny);
...
void init_nm1_(real *gb_tt_np1, real *gb_tt_n, real *gb_tt_nm1, real *gb_tt_t_n,
               ...
               real *phi4_r_np1, real *phi4_r_n, real *phi4_r_nm1, real *phi4_r_t_n, 
               real *phi4_i_np1, real *phi4_i_n, real *phi4_i_nm1, real *phi4_i_t_n, 
			   real *tfunction,
...
void approx_qb_(real *phi_r, real *phi_i, real *phi_r_dot, real *phi_i_dot,
                real *amp, real *r0, real *delta, real *xu0, real *yu0, real *ax, real *ay,
                real *omega, int *use_phi4dat, real *AdS_L, real *x, real *y, int *Nx, int *Ny);
